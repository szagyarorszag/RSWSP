...
public class Organization {
    ...
    private EnumSet<Faculty> faculties;
    private Date creationDate;

    public Organization() {}

    public Organization(String name, Vector<Student> members, Student lead, EnumSet<Faculty> faculties, Date creationDate) {
        this.name = name;
    ...
    public EnumSet<Faculty> getFaculties() {
        return faculties;
    }
    ...
    public void setFaculties(EnumSet<Faculty> faculties) {
        this.faculties = faculties;
    }
